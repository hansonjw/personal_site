...
export default function Logo({ size = 48 }: LogoProps) {
  ...
  const yellowCx = cx + eclipseOffset * Math.cos((30 * Math.PI) / 180)
  const yellowCy = cy + eclipseOffset * Math.sin((30 * Math.PI) / 180)
  const blueCx = cx + eclipseOffset * Math.cos((270 * Math.PI) / 180)
  const blueCy = cy + eclipseOffset * Math.sin((270 * Math.PI) / 180)
  const redCx = cx + eclipseOffset * Math.cos((150 * Math.PI) / 180)
  const redCy = cy + eclipseOffset * Math.sin((150 * Math.PI) / 180)
